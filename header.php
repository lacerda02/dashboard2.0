	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				...
				<a href="header.php" class="logo logo-small"> <img src="assets/img/11.jpg" alt="Logo" width="30" height="30"> </a>
			</div>
						...
						<div class="noti-content">
							<ul class="notification-list">
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="assets/img/11.jpg">
											</span>
								...
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="assets/img/profiles/11.jpg">
											</span>
											<div class="media-body">
		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="active"> <a href="header.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Usuarios </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								<li><a href="all-customer.php"> Todos Usuarios  </a></li>
