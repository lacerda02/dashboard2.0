	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="home.php" class="logo"> <img src="assets/img/complete.png" width="50" height="70" alt="logo"> <span class="logoclass">HOTEL</span> </a>
				<a href="home.php" class="logo logo-small"> <img src="assets/img/11.jpg" alt="Logo" width="30" height="30"> </a>
			</div>
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Usuarios </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								<li><a class="active" href="all-customer.php">Todos Usuarios </a></li>
								<li><a href="edit-customer.php"> Editar Usuarios </a></li>
								<li><a href="add-customer.php"> Add Usuarios </a></li>
							</ul>
						</li>
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">Todos usuarios</h4> <a href="add-customer.php" class="btn btn-primary float-right veiwbutton">Add Customers</a> </div>
						</div>
					</div>
				</div>
				<div class="row">
										...
										<tbody>
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="profile.html">Leonardo Lacerda <span>#0001</span></a>
                                                    </h2>
                                                </td>
												<td>Double</td>
												<td>10</td>
											...
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="profile.html">José Nuvunga <span>#0002</span></a>
                                                    </h2>
                                                </td>
												<td>Single</td>
												<td>8</td>
											...
											<tr>
												...
												<td>
													<h2 class="table-avatar">
                                                        ...
                                                        <a href="profile.html">Charmila Simbine <span>#0003</span></a>
                                                    </h2>
                                                </td>
												<td>Double</td>
												<td>10</td>
											...
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="profile.html">Audencia Crimildo <span>#0004</span></a>
                                                    </h2>
                                                </td>
												<td>Single</td>
												<td>15</td>
											...
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="profile.html">Nelma Ester <span>#0005</span></a>
                                                    </h2>
                                                </td>
												<td>Double</td>
												<td>12</td>
											...
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="profile.html">Claudio Ussimane <span>#0006</span></a>
                                                    </h2> 
                                                </td>
												<td>Single</td>
												<td>7</td>
